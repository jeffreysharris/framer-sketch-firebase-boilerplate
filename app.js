...
var FirebaseFramer, Input, Slice, _assets, _layers, _slices, anima, asset, child, constant, constraint, constraints, container, getObject, j, layer, len, ref, ref1, ref2, slice, slices,
...
for (slice in slices) {
  ...
  if (layer.layers.length > 0) {
    for (slice in slices) {
      child = getObject(layer.layers, "id", slices[slice].sketch_id);
      if (child != null) {
