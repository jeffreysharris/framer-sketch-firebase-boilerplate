...
var FirebaseFramer, HEIGHT, Input, Slice, WIDTH, _anima, _assets, _slices, anima, asset, constant, constraint, constraints, container, fn, getObject, j, len, lineHeight, prop, ref, ref1, slice, slices,
...
for (slice in slices) {
  ...
  container = (ref1 = slices[slice].parent.toString) != null ? ref1 : "Screen";
      ...
      for (prop in _anima) {
        if (constraint === prop) {
          ...
          if (prop === "width" || "height") {
            fn = eval(container + _anima[prop]["function"]);
          } else {
