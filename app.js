...
var FirebaseFramer, HEIGHT, Input, Slice, WIDTH, _anima, _assets, _slices, anima, asset, constant, constraint, constraints, container, getObject, j, len, lineHeight, prop, ref, ref1, ref2, slice, slices,
        ...
        if (constraint === prop) {
          ...
          switch (prop) {
            ...
            case "right":
              ...
              break;
            case "width":
              slices[slice].width = Screen.width;
              break;
            case "height":
