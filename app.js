...
var FirebaseFramer, HEIGHT, Input, WIDTH, _anima, _assets, _slices, anima, asset, constraint, constraints, getObject, j, len, lineHeight, prop, ref, slice, slices;
  ...
  if (constraints) {
    for (constraint in constraints) {
      for (prop in _anima) {
        if (constraint === prop) {
          print(_anima[prop]);
          slices[slice.name][_anima[prop].attribute] = _anima[prop]["function"];
        }
      }
    }
    break;
